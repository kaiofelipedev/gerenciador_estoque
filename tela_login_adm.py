...
class TelaLoginAdm:
    def __init__(self, window):
        self.window = window
        self.frm_login_adm = Frame(self.window, background="#D9AD29", border=8,
                highlightcolor="#592202", highlightthickness=8,
                highlightbackground="#592202", relief=RAISED)
        self.frm_login_adm.place(relwidth=.5, relheight=.7, relx=.25, rely=.1)
        # Label 'Login'
        self.lb_login = Label(self.frm_login_adm, text="Login", border=4, relief=RAISED,
        ...
        # Label 'Senha'
        self.lb_senha = Label(self.frm_login_adm, text="Senha", border=4, relief=RAISED,
                        font=("Verdana", 12, "bold"), background="#F2522E",highlightbackground="#592202", highlightthickness=2)
        self.lb_senha.place(relx=.1, rely=.48, relwidth=.3, relheight=.2)
        # Entry de 'Login'
        self.entry_login = Entry(self.frm_login_adm, font=("Arial", 12),
        ...
        # Entry de 'Senha'
        self.entry_senha = Entry(self.frm_login_adm, font=18,
                                bg="#592202", fg="white", borderwidth=6,
                                relief="groove", show="@", insertbackground="white",
                                insertwidth=10)
        self.entry_senha.place(relx=.1, rely=.7, relwidth=.6, relheight=.15)
        # Botão 'voltar'
        self.bt_voltar = Button(self.frm_login_adm, text="Voltar", relief=RAISED, bd=6,
        ...
        # Botão 'Entrar'
        self.bt_entrar = Button(self.frm_login_adm, text="Entrar", relief=RAISED, bd=6,
                     font=("Verdana", 10, "bold"), background="#F2522E", activebackground="#F27B35",activeforeground="white",
...
####################################################################################
    def voltar_tela_inicial(self):
        self.frm_login_adm.place_forget()
